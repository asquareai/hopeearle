jQuery(function ($) {
    ...
    //        $(".user1").hide(); $(".navbar-fixed-top").addClass('animated slideInDown');
    ...
    $(document).ready(function () {
        ...
        $(".tab").click(function ()
        {
            ...
            $(".tab1").css("border-bottom", "2px solid #e1e1e1"); $(".careerID").hide(); $(".contactID").show();
        }); $(".tab1").click(function () { $(this).css("border-bottom", "2px solid #09a4e0"); $(".tab").css("border-bottom", "2px solid #e1e1e1"); $(".careerID").show(); $(".contactID").hide(); }); var hashVal = window.location.hash.substr(1); var ref = hashVal + "_link"; $(".scroll").removeClass("active"); $("." + ref).addClass("active");
    });
    function Scroll() {
        var contentTop = [];
        var contentBottom = [];
    ...
    $('.accordion-toggle').on('click', function () {
        ...
        $("#main-slider").find('.owl-carousel').owlCarousel(
            {
                slideSpeed: 500, paginationSpeed: 500, singleItem: true, navigation: true, navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"], afterInit: progressBar, afterMove: moved, startDragging: pauseOnDragging, transitionStyle: "fadeUp"
            });
        ...
        function start() {
            percentTime = 0; isPause = false; tick = setInterval(interval, 10);
        };
        function interval() {
