...
<body id="home" class="homepage" style="background: #f4f4f4;">
    ...
    <header id=header>
        <nav class="navbar navbar-default navbar-fixed-top" id="main-menu" style="background-color: hsla(0, 0%, 100%, 0.8); border-bottom-left-radius: 1em; border-bottom-right-radius: 1em; box-shadow: none !important; border: 1px solid hsla(0, 0%, 0%, 0.4) ;" id=main-menu role=banner>

            <div id="TopHeight" style="">
                <div class="row" style="">
                    <div class="col-sm-4  algcenter MobposView">

                        <a href="mailto:mail@hopeearle.com.au"><img class="imgsize" src="Image/Icon/mail.png" /> &nbsp;<span class="topFontCSS"><u>mail@hopeearle.com.au</u></span>  </a>
                    </div>
                    <div class="col-sm-4  col-xs-8 algcenter">
                        <img class="imgsize" style="width:12px;" src="Image/Icon/phone.png" /> &nbsp;<span class="topFontCSS"> <a class="Mouseover" href="tel:+61 3 9600 3330"> <u>+61 3 9600 3330</u></a></span>
                    </div>
                    <div class="col-sm-4  col-xs-4 algcenter MobposView1">
                        <a href="https://www.facebook.com/hope.earle.lawyers" target="_blank"><img style="width: 9px; margin-top: -4px; " src="Image/Icon/fac.png" /></a> &nbsp;&nbsp;
                        <a href="https://twitter.com/HopeEarle" target="_blank"><img class="imgsize" src="Image/Icon/twit.png" /></a> &nbsp;&nbsp;
                        <a href="https://goo.gl/c9V7ZK" target="_blank"><img class="imgsize" src="Image/Icon/LinkedIn.png" /></a>
                    </div>
                </div>
            </div>
            ...
            <div class=container>
                <div class=navbar-header>
                    ...
                    <a href=index.html class=navbar-brand><img src=Image/LOGO.png class=logoimg alt=logo></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav ">
                        <li class="scroll active home1_link">
                            <a href=index.html class="scr ram"><b>Home</b></a>
                        </li>
                        <li class="scroll home1_link">
                            <a href=index.html#portfolio class=scr><b>Philosophy</b></a>
                        </li>
                        <li class="scroll home1_link">
                            <a href="index.html#ExpertiseSecCls" class=scr><b>Expertise</b></a>
                        </li>


                        <li class="scroll career get-in-touch1_link"><a href=index.html#PeopleContent class="scr career"><b>People</b></a></li>
                        <li class="scroll career get-in-touch1_link"><a href="News.html" class="scr sub-menuNews"><b>News</b></a></li>
                        <li class="scroll contact get-in-touch_link"><a href="Contact.aspx#" class="scr contact activelink"><b>Contact</b></a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-bottom: 41px; ">
                        ...
                        <div class="form-group" style="position: relative; right: 4px;">
                            <p>For any questions or queries or for a confidential, no-obligation discussion, Please <a href="tel:+61 3 9600 3330" style=""><b>call us</b> </a>or complete the form below and one of our lawyers will get back to you promptly.</p>
                        </div>
                        <div class="form-group" style="position: relative; right: 4px;">
                    ...
                    <div class="col-sm-6" style="margin-top: 80px;margin-bottom:10px;">
                        <div>
                            <span class="glyphicon glyphicon-map-marker" style="color: #1ab78d; position: relative; top: 9px; right: 22px;font-size: 22px; "></span>
                            <span class="addressFontCss" style="margin-right: 17px; "> Level 22, 535 Bourke Street,</span><br />
                            <span class="addressFontCss" style="margin-left: 1px; ">
                                Melbourne Victoria 3000,
                            </span><br />
                            <span class="addressFontCss" style="margin-right: 100px; ">Australia.</span>

                        </div>
                        <div style="margin-top: 10px;">

                            <span class="glyphicon glyphicon-earphone" style="color:#1ab78d;position:relative; top:11px;right: 16px;font-size: 22px; "></span>
                            <span class="addressFontCss" style="margin-right: 85px; "><a href="tel:+61 3 9600 3330"><b>+61 3 9600 3330</b></a></span><br />
                           <%-- <span class="addressFontCss" style="margin-right: 58px; ">
                                +61 3 9600 3331
                            </span>--%>
                        ...
                        <div style="margin-top:10px;margin-bottom:30px;">
                            ...
                            <span class="glyphicon glyphicon-envelope" style="color: #1ab78d; position: relative; top: 9px; right: 20px; font-size: 22px;"></span>
    ...
    <footer id="footer" style="background-color: #08212b; ">
        <div class=container>
            <div class=row>
                <div class="col-sm-3">
                    <div><img src="Image/LOGO_white.png" width="110px;" /></div><br /> <div> <div class="row"> <div class="col-sm-12"> <span class="footFontclrcol1">Liability Limited by a scheme</span> </div></div><div class="row"> <div class="col-sm-12"> <span class="footFontclrcol1">approved under Professional</span> </div></div><div class="row"> <div class="col-sm-12" style="color:gray"> <span class="footFontclrcol1">Standards Legislation</span> </div></div></div><br /> <br />
                    <div><span class="footFontclrcol1">©2018 Hope Earle</span></div>
                </div>
                <br />
         <div class="col-sm-3">
                    <span class="footFontclr">RECENT NEWS</span>
                    <div class="row" style="margin-top:22px">
                        <a href="News/16/HopeEarle_News_Defending_A_Magistrates’_Court_Complaint.html">
                            <div class="col-sm-3 col-xs-3">
                                <time datetime="2017-01-31" class="icon"> <strong>Apr</strong> <span>26</span> </time>
                            </div>
                            <div class="col-sm-8 col-xs-8" style=" padding-left: 0px;"> <p>Defending a Magistrates’ Court Complaint</p></div>
                        </a>
                    </div>
					
					<div class="row" style="margin-top:10px">
                             <a href="News/15/HopeEarle_News_Corporate_Fraud.html">
                                  <div class="col-sm-3 col-xs-3">
                                      <time datetime="2017-01-12" class="icon">
                                          <strong>Apr</strong> <span>20</span>
                                      </time>
                                  </div><div class="col-sm-8 col-xs-8" style=" padding-left: 0px;"><p>Corporate Fraud</p></div>
                              </a>
                    </div><br />
                </div>
                <div class="col-sm-3">
                    <span class="footFontclr"> LINKS </span> <br /><br /> <div class="row"> <div class="col-sm-6"> <div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="index.html#"><span class="footFontclrcol2">Home</span></a></div></div></div><div class="row"> <div class="col-sm-6"> <div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="index.html#ExpertiseSecCls"><span class="footFontclrcol2">Expertise</span> </a></div></div><div class="col-sm-6"> </div></div><div class="row">
                        <div class="col-sm-6"><div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="index.html#portfolio"><span class="footFontclrcol2">Philosophy</span></a></div>
                        </div><div class="col-sm-6" style=""> </div>
                    </div><div class="row"> <div class="col-sm-10"> <div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="News.html"><span class="footFontclrcol2">News & Knowledge</span></a></div></div><div class="col-sm-2"> </div></div><div class="row"> <div class="col-sm-6"> <div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="index.html#PeopleContent"><span class="footFontclrcol2">People</span></a> </div></div></div><div class="row"> <div class="col-sm-6"> <div><span style="color: #35c486" class="fa fa-angle-right "></span>&nbsp;<a href="Contact.aspx"><span class="footFontclrcol2">Contact</span></a></div></div><br /></div>
                </div>

                <div class="col-sm-3">
                    <span class="footFontclr"> CONTACT </span> <br /><br /> <div class="row">
                        <div class="col-sm-2 col-xs-1"> <span class="glyphicon glyphicon-map-marker FOOTERCLS" style="margin-top:2px;"></span> </div>
                        <div class="col-sm-9 col-xs-11">
                            <span class="footFontclrcol2"> Level 22, 535 Bourke Street, </span>
                            <span class="footFontclrcol2"> Melbourne Victoria 3000, </span> <span class="footFontclrcol2"> Australia.</span>
                        </div>
                    </div><br /> <div class="row">
                        <div class="col-sm-2 col-xs-1">
                            <span class="glyphicon glyphicon-earphone FOOTERCLS"></span>
                        </div><div class="col-sm-9 col-xs-11">
                            <span class="footFontclrcol2">
                                <a href="tel:+61 3 9600 3330"><u> +61 3 9600 3330</u></a>
                            </span>
                        </div>
                    </div><br /> <div class="row">
                        <div class="col-sm-2 col-xs-1">
                            <span class="glyphicon glyphicon-envelope FOOTERCLS"></span>
                        </div><div class="col-sm-9 col-xs-11">
                            <span class="footFontclrcol2"> <a href="mailto:mail@hopeearle.com.au"> <u>mail@hopeearle.com.au</u></a> </span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function ContactEmail() {
            ...
            if (FirstName == "") {
                ...
                if (errors == "* Invalid email address format") {
