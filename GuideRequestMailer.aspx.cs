...
public partial class GuideRequestMailer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			sendmail("venkatesan.m@pragrobotics.com","test","tested");
   ...
   // [System.Web.Services.WebMethod]
    ...
    protected void ContactSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            textBody += "</table></body></html>";
            string result = sendmail(ConfigurationManager.AppSettings["ToMailAddress"].ToString(), "WEBSITE QUERY - " + Firstname.Text, textBody);
